...
if __name__ == "__main__":
    ...
    env = UPMSP(log_dir=event_path, num_j=1500, num_m=8, action_number=action_size, min=0.01, max=2.1, action_mode='WCOVERT')  # 환경을 설정하기 위한 파라미터
    ...
    agent.network.load_state_dict(torch.load('output/train/model/ppo/episode22500.pt')["model_state_dict"])
