...
if __name__ == "__main__":
    ...
    env = UPMSP(log_dir=event_path, num_j=1000, num_m=8, action_number=action_size, min=0.1, max=4, action_mode='heuristic')  # action_mode 바꿔야 함 heuristic, WCOVERT
    ...
    agent.network.load_state_dict(torch.load('../result/model/dqn/episode8000.pt')["model_state_dict"])
